...
/**
 * Servlet implementation class StudyGet
 */
@WebServlet("/StudyGet")
public class StudyGet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("study", sp.getByKey(studyID));
		request.getRequestDispatcher("pages/forms/studyForm.jsp").forward(request, response);
	}
